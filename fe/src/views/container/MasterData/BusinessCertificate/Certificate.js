...
class Certificate extends React.PureComponent {
   ...
   render() {
      ...
      const columns = [
         {
            title: strings.BUSINESS_CER_PAGE_TABLE_COLUMN_TITLE_PICTURE,
            dataIndex: "image",
            render: (cellData) => {
         ...
         {
            title: strings.BUSINESS_CER_PAGE_TABLE_COLUMN_TITLE_CATEGORY_NAME,
            dataIndex: "name",
         ...
         {
            title: strings.BUSINESS_CER_PAGE_TABLE_COLUMN_TITLE_DESCRIPTION,
            dataIndex: "note",
         ...
         {
            title: strings.BUSINESS_CER_PAGE_TABLE_COLUMN_TITLE_SLUG,
            dataIndex: "slug",
            render: (cellData, records) => {
               return cellData;
            }
         ...
         <>
            <div className='form-search-header'>
               <SearchField
                  ...
                  placeholder={strings.BUSINESS_CER_PAGE_HEADER_PLACEHOLDER_SEARCH}
                  size='small'
               ...
               <div className='col-5'>
                  ...
                  <div className='form-category'>
                     <h4 className='mt-5 mb-5'>
                        {isEdit
                           ? strings.BUSINESS_CER_PAGE_TITLE_FORM_UPDATE
                           : strings.BUSINESS_CER_PAGE_TITLE_FORM_ADD}
                     </h4>
                        ...
                        <Row>
                           <Form.Item>
                              <Col>
                                 <InputField
                                    name='name'
                                    required
                                    placeholder={strings.BUSINESS_CER_PAGE_FORM_LABEL_NAME}
                                    value={values.name}
                                 ...
                                 <div className='short-desciption'>
                                    <p>{strings.BUSINESS_CER_PAGE_FORM_SHORT_DESCRIPTION_NAME}</p>
                                 </div>
                              </Col>
                           </Form.Item>
                           <Form.Item>
                              <Col span={24}>
                                 <InputField
                                    name='slug'
                                    placeholder={strings.BUSINESS_CER_PAGE_FORM_LABLE_SLUG}
                                    value={values.slug}
                                 ...
                                 />
                                 <div className='short-desciption'>
                                    <p>{strings.BUSINESS_CER_PAGE_FORM_SHORT_DESCRIPTION_SLUG}</p>
                                 </div>
                              </Col>
                           </Form.Item>
                           ...
                           <Form.Item>
                              <Col span={24}>
                                 <TextAreaField
                                    ...
                                    onChange={handleChange}
                                    onBlur={handleBlur}
                                    label={strings.BUSINESS_CER_PAGE_FORM_LABLE_DESCRIPTION}
                                 />
                                 <div className='short-desciption'>
                                    <p>{strings.BUSINESS_CER_PAGE_FORM_SHORT_DESCRIPTION_DESCRIPTION}</p>
                                 </div>
                              </Col>
                           </Form.Item>
                           ...
                           <Form.Item>
                              <UIButton
                                 ...
                                 {isEdit
                                    ? strings.BUSINESS_CER_PAGE_FORM_BUTTON_EDIT
                                    : strings.BUSINESS_CER_PAGE_FORM_BUTTON_CREATE}
                              </UIButton>
            ...
            updateCategory(values)
               .then((result) => {
                  ...
                  getAllCategories(parseInt(pagination.total) + 1, 1, "", "").then(({ res }) => {
                     let index = -1;
                     res.map((cate, i) => {
                        if (result.res.id === cate.id) index = i;
                     });
