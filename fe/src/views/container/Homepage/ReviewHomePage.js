         ...
         <div className='testimonial-card'>
            <div className='testi-desc-box'>
               <p className='testi__desc'>
                  Excepteur sint occaecat cupidatat non proident sunt in culpa officia deserunt mollit anim laborum sint
                  occaecat cupidatat non proident. Occaecat cupidatat non proident des.
               </p>
            </div>
