   ...
   try {
      ...
      for (let index = 0; index < arrYears.length; index++) {
         ...
         for (let i = 1; i < NorthernVietnam.length; i++) {
            ...
            if (NorthernVietnam[i].numbersYoung === null) NorthernVietnam[i].numbersYoung = 0;
            if (NorthernVietnam[i].numbersChildren === null) NorthernVietnam[i].numbersChildren = 0;
            if (NorthernVietnam[i].numbersBaby === null) NorthernVietnam[i].numbersBaby = 0;
         }
         NorthCentral = ['NorthCentral', ...listReport[1 + 8 * index]];
         for (let i = 1; i < NorthCentral.length; i++) {
            if (NorthCentral[i].numbersPeople === null) NorthCentral[i].numbersPeople = 0;
            if (NorthCentral[i].numbersYoung === null) NorthCentral[i].numbersYoung = 0;
            if (NorthCentral[i].numbersChildren === null) NorthCentral[i].numbersChildren = 0;
            if (NorthCentral[i].numbersBaby === null) NorthCentral[i].numbersBaby = 0;
         }
         SouthCentralCoast = ['SouthCentralCoast', ...listReport[2 + 8 * index]];
         for (let i = 1; i < SouthCentralCoast.length; i++) {
            if (SouthCentralCoast[i].numbersPeople === null) SouthCentralCoast[i].numbersPeople = 0;
            if (SouthCentralCoast[i].numbersYoung === null) SouthCentralCoast[i].numbersYoung = 0;
            if (SouthCentralCoast[i].numbersChildren === null) SouthCentralCoast[i].numbersChildren = 0;
            if (SouthCentralCoast[i].numbersBaby === null) SouthCentralCoast[i].numbersBaby = 0;
         }
         CentralHighlands = ['CentralHighlands', ...listReport[3 + 8 * index]];
         for (let i = 1; i < CentralHighlands.length; i++) {
            if (CentralHighlands[i].numbersPeople === null) CentralHighlands[i].numbersPeople = 0;
            if (CentralHighlands[i].numbersYoung === null) CentralHighlands[i].numbersYoung = 0;
            if (CentralHighlands[i].numbersChildren === null) CentralHighlands[i].numbersChildren = 0;
            if (CentralHighlands[i].numbersBaby === null) CentralHighlands[i].numbersBaby = 0;
         }
         ...
         for (let i = 1; i < Southeast.length; i++) {
            ...
            if (Southeast[i].numbersChildren === null) Southeast[i].numbersChildren = 0;
         ...
         for (let i = 1; i < MekongRiverDelta.length; i++) {
            if (MekongRiverDelta[i].numbersPeople === null) MekongRiverDelta[i].numbersPeople = 0;
            if (MekongRiverDelta[i].numbersYoung === null) MekongRiverDelta[i].numbersYoung = 0;
            if (MekongRiverDelta[i].numbersChildren === null) MekongRiverDelta[i].numbersChildren = 0;
            if (MekongRiverDelta[i].numbersBaby === null) MekongRiverDelta[i].numbersBaby = 0;
         }
         VietNam = [
            'VietNam',
            NorthernVietnam,
         ...
         for (let i = 1; i < 13; i++) {
            ...
            for (let j = 1; j < report.length; j++) {
               if (j === 1) {
                  sum.numbersPeople += report[j][report[j].length - 1][i].numbersPeople;
                  sum.numbersYoung += report[j][report[j].length - 1][i].numbersYoung;
                  sum.numbersChildren += report[j][report[j].length - 1][i].numbersChildren;
